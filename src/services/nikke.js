...
const NIKKE_UNITS = [
    ...
    { id: 239001, name_code: 5088, name: "Zwei", getol: true},
    { id: 108001, name_code: 5021, name: "Centi", getol: true},
    { id: 586001, name_code: 5164, name: "Chisato", getol: true},
    { id: 586101, name_code: 5165, name: "Takina", getol: true},
    { id: 301701, name_code: 5169, name: "Anis: Star", getol: true },
    { id: 101801, name_code: 5170, name: "Neon: Vision Eye", getol: true },
    { id: 360001, name_code: 5172, name: "Mint", getol: true },
...
export function getNameByCode(code) {
  const unit = nikkeBase.find(u => u.name_code === Number(code));
